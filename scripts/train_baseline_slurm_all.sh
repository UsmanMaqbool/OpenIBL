...
## To RUN
# sbatch --j 1002-s1 scripts/train_baseline_slurm_all.sh graphvlad vgg16 pitts 30k
####################################################################################################
...
# LOSS="sare_ind"
# DATE=$(date '+%d-%b') 
# FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/1002-try1/${ARCH}-${METHOD}-${LOSS}-${DATASET}${SCALE}-lr${LR}-tuple${GPUS}-${DATE}"
...
#   --eval-step 1 --epochs 5 --step-size 5 --cache-size 1000 --logs-dir ${FILES} --data-dir ${DATASET_DIR} \
#   --init-dir ${INIT_DIR} --fast-scnn=${FAST_SCNN} \
#   --method ${METHOD} 

FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/1002-try1/vgg16-graphvlad-sare_ind-pitts30k-lr0.001-tuple4-04-Oct"
