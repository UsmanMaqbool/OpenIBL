...
## To RUN
# sbatch --j 0917-s1 scripts/train_sfrs_slurm_all.sh graphvlad vgg16 pitts 30k
####################################################################################################
...
LOSS="sare_ind"
DATE=$(date '+%d-%b') 
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/0915-try2/${ARCH}-${METHOD}_SFRS-${LOSS}-${DATASET}${SCALE}-lr${LR}-tuple${GPUS}-${DATE}"
