...
PCA_PATH="/home/m.maqboolbhutta/usman_ws/models/openibl/pitts-graphvlad-triplet-lr0.01-18-Apr/pca_params_checkpoint3.h5"
SCALE=30k
ARCH=vgg16
LAYERS=conv5
LR=0.01
...
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/pitts-graphvlad-sare_ind-lr0.01-18-Apr"
echo ${FILES}
...
DATE=$(date '+%d-%b') 
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/${DATASET}-${METHOD}-${LOSS}-lr${LR}-${DATE}"
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/pitts-graphvlad-sare_joint-lr0.01-18-Apr"
# echo ${FILES}
...
DATE=$(date '+%d-%b') 
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/${DATASET}-${METHOD}-${LOSS}-lr${LR}-${DATE}"
FILES="/home/m.maqboolbhutta/usman_ws/models/openibl/pitts-graphvlad-triplet-lr0.01-18-Apr"
# echo ${FILES}
