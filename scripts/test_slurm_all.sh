...
## To RUN
#  sbatch --j 0903-s2 scripts/test_slurm_all.sh graphvlad vgg16 /home/m.maqboolbhutta/usman_ws/models/openibl/0924-s2-fusion/vgg16-graphvlad_SFRS-sare_ind-pitts30k-lr0.001-tuple4-24-Sep/
####################################################################################################
