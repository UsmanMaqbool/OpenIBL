...
## To RUN
#  sbatch --j 0917-s1-pca scripts/leo/test_slurm_pca.sh graphvlad vgg16 /home/m.maqboolbhutta/usman_ws/models/openibl/0915-try2/vgg16-graphvlad_SFRS-sare_ind-pitts30k-lr0.001-tuple4-17-Sep
...
do
  ...
  $PYTHON -m torch.distributed.launch --nproc_per_node=$GPUS --master_port=$PORT --use_env \
   examples/test_pca.py --launcher pytorch \
